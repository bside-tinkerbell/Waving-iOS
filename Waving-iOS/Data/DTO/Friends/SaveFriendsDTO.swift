...
struct SaveFriendsDTO: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        self.profileList = try container.decode([ContactEntity].self, forKey: .profileList)
    }
    
    init(userId: Int, contactId: Int, profileList: [ContactEntity]){
        self.userId = userId
