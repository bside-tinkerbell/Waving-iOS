...
final class LoginViewController: UIViewController, SnapKitInterface {
    ...
    lazy private var doneButtonModel = WVButtonModel(title: "두 번 탭하세요", isEnabled: false, titleColor: .Text.white, backgroundColor: .Button.mainBlackButton) { [weak self] in
